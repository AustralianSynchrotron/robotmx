...
Function GTgetAdaptorAngleErrorProbePoint(cassette_position As Integer, perfectPointNum As Integer, standbyPointNum As Integer, destinationPointNum As Integer)
	...
	dy = (superpuck_edge_y + offsetYfromPortDeepEnd) * CASSETTE_SHRINK_FACTOR
	dz = superpuck_edge_z * CASSETTE_SHRINK_FACTOR
...
Function GTsetupAdaptorAngleCorrection(cassette_position As Integer, error_from_perfectPoint_in_mm As Real) As Boolean
	...
	GTUpdateClient(TASK_DONE_REPORT, LOW_LEVEL_FUNCTION, "GTsetupAdaptorAngleCorrection: For Superpuck " + GTCassetteName$(cassette_position) + " adaptorAngleError=" + Str$(adaptorAngleError) + "degrees")
