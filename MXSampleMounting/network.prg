...
errHandler:
	UpdateClient(FOREGROUND_ERR, "IsUseEval !!Error:" + " " + Str$(Err) + " " + ErrMsg$(Err) + " " + "Line: " + Str$(Erl), 0)
	EResume SkipTask
Fend
''Called by JobWorker, and IsCmdBackground
...
Function JobWorker
	...
	If IsUseEval(FOREGROUND, forecmd$) Then
		...
		If g_JobSolverReply$ <> "" Then
			...
			UpdateClient(FOREGROUND_ERR, err$, 0)
		EndIf
	Else
		''User trying to call SPEL task
		''Set JobSolverBusy flag true
...
Function task1
	String error$
   	Do While 1
		Wait 1
		UpdateClient(TASK_PROG, "Step 1 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of this", 0)
		UpdateClient(TASK_MSG, "log i am doing this", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 2 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of that", 0)
		UpdateClient(TASK_MSG, "log i am doing that", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 3 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of this", 0)
		UpdateClient(TASK_MSG, "log i am doing this", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 4 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of that", 0)
		UpdateClient(TASK_MSG, "log i am doing that", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 5 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of this", 0)
		UpdateClient(TASK_MSG, "log i am doing this", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 6 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of that", 0)
		UpdateClient(TASK_MSG, "log i am doing that", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 7 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of this", 0)
		UpdateClient(TASK_MSG, "log i am doing this", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 8 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of that", 0)
		UpdateClient(TASK_MSG, "log i am doing that", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 9 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of this", 0)
		UpdateClient(TASK_MSG, "log i am doing this", 0)
		Wait 1
		UpdateClient(TASK_PROG, "Step 10 of 10", 0)
		UpdateClient(TASK_MSG, "Doing bit of that", 0)
		UpdateClient(TASK_MSG, "log i am doing that", 0)
	Loop
Fend
