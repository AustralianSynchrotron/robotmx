...
Fend
Function GTForceScan(forceName As Integer, destinationPoint As Integer, fineTune As Boolean) As Boolean
  	GTForceScan = False
    ...
    FTHNumSteps = HypDistance(ByRef g_CurrentP(), ByRef FTHDestP()) / 0.1 ''GetTouchStepSize(forceName)
    ...
    If FTHNumSteps > 0 Then
       ...
       If Not ForceScan(forceName, FTHThreshold, ByRef FTHDestP(), FTHNumSteps, fineTune) Then
       ...
       EndIf
    Else
       msg$ = "GTForceScan: Arrived at destination and force did not satisfy threshold, exit"
...
Function SetGlobals
	g_LeftarmSystem = False
	g_IncludeStrip = False
	g_Perfect_Cradle_Angle = 90
	g_Perfect_U4Holder = 90
	g_Perfect_DownStream_Angle = 180
	g_Perfect_LeftCassette_Angle = 90
