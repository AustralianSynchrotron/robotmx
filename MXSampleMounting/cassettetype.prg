...
Function GTCassetteTypeFromHeight(cassette_position As Integer, cassetteHeight As Real, ByRef min_height_error As Real) As Integer
	Real calib_highEdge_height_in_LN2, calib_lowEdge_height_in_LN2
	Real normal_height_in_LN2, superpuck_height_in_LN2
	Real guessedCassetteExpectedHeight
	String msg$
	...
	If (calibration_height_difference < normal_height_difference) And (calibration_height_difference < superpuck_height_difference) Then
		...
		guessedCassetteExpectedHeight = calib_lowEdge_height_in_LN2
	ElseIf (normal_height_difference < calibration_height_difference) And (normal_height_difference < superpuck_height_difference) Then
		...
		guessedCassetteExpectedHeight = normal_height_in_LN2
	Else
		guessedCassetteType = SUPERPUCK_CASSETTE
		min_height_error = superpuck_height_difference
		guessedCassetteExpectedHeight = superpuck_height_in_LN2
	EndIf
	
	msg$ = "GTCassetteTypeFromHeight reports:  guessedCassetteType=" + GTCassetteType$(guessedCassetteType) + ","
	msg$ = msg$ + "guessedCassetteExpectedHeight=" + Str$(guessedCassetteExpectedHeight) + ","
	msg$ = msg$ + "height_difference=" + Str$(min_height_error) + "."
	UpdateClient(TASK_MSG, msg$, INFO_LEVEL)
		
	GTCassetteTypeFromHeight = guessedCassetteType
Fend
